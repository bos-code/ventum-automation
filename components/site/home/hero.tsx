...
export function Hero({ settings, productCount, brandCount, products }: { settings: Settings; productCount: number; brandCount: number; products: ProductView[] }) {
  ...
  return (
    <section className="relative isolate min-h-[760px] overflow-hidden bg-[#03031f] text-white lg:min-h-[820px]">
      ...
      <div aria-hidden="true" className="ventum-orbit ventum-orbit-a pointer-events-none absolute -right-[18vw] top-[-22vw] size-[70vw] rounded-full border border-white/[0.07]" />
      <div aria-hidden="true" className="ventum-orbit ventum-orbit-b pointer-events-none absolute right-[7vw] top-[12%] size-[42vw] rounded-full border border-[#ed0101]/10" />
      ...
      <div className="ventum-shell relative grid min-h-[760px] items-center gap-10 py-14 lg:min-h-[820px] lg:grid-cols-[.92fr_1.08fr] lg:gap-4 lg:py-16">
        <div className="relative z-20 max-w-3xl lg:pr-4">
          <div className="ventum-reveal ventum-delay-1 flex items-center gap-3 font-mono text-[9px] font-bold uppercase tracking-[.2em] text-white/48 sm:text-[10px]">
            <span className="ventum-rule h-px bg-[#ed0101]" />
            Ventum Global Automation · Lagos
          </div>

          <h1 className="ventum-reveal ventum-delay-2 ventum-display mt-7 text-[clamp(3.8rem,9vw,8.2rem)] leading-[.83] tracking-[-.075em] text-white">
            Control
            <span className="block text-white/28">the power.</span>
            <span className="block text-[#ed0101]">Protect the work.</span>
          </h1>

          <p className="ventum-reveal ventum-delay-3 mt-8 max-w-lg text-sm leading-7 text-white/62 sm:text-base sm:leading-8">
          ...
          <div className="ventum-reveal ventum-delay-4 mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <div className="ventum-reveal ventum-delay-5 mt-12 flex max-w-lg border-y border-white/12">
        ...
        <div className="relative z-10 min-h-[430px] sm:min-h-[540px] lg:min-h-[680px]">
          <div className="ventum-stage-in absolute inset-[2%_0_8%_4%] sm:inset-[0_0_4%_5%] lg:inset-[2%_-8%_2%_2%]">
            ...
            <div className="ventum-product-float relative h-full">
          ...
          <div className="ventum-side-in absolute right-0 top-4 z-20 border-l-2 border-[#ed0101] bg-[#03031f]/82 px-4 py-3 backdrop-blur-md sm:right-4 sm:top-10">
          ...
          <div className="absolute bottom-0 left-0 right-0 z-20 grid grid-cols-2 border-y border-white/12 bg-[#03031f]/84 backdrop-blur-lg sm:left-auto sm:w-[82%] sm:grid-cols-3">
            {[second, third].map((product, index) => product ? (
              <div key={product.id} className={index === 0 ? "ventum-tile-in ventum-delay-5" : "ventum-tile-in ventum-delay-6"}>
      ...
      <div aria-hidden="true" className="ventum-bottom-line absolute bottom-0 left-0 h-px w-full origin-left bg-gradient-to-r from-[#ed0101] via-white/25 to-transparent" />
    </section>
  );
}
